...
class MyLitCube(private val myContext:Context) {
    ...
    private val fragmentShaderCode =
                ...
                "out vec4 fragColor;            \n" +
                "void main(){                   \n" +
                "   fragColor = vec4(fNormal,1.0) * texture(sTexture, fTexCoord);            \n" +
                "}                              \n"
...
//        val specular= floatArrayOf(specularLight[0]*matSpecular[0],specularLight[1]*matSpecular[1],specularLight[2]*matSpecular[2],1.0f)
//
...
//
//        GLES30.glUniform4fv(lightDirHandle,1,lightDir,0)
